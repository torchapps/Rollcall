<section class="container">
	<div class="row">
		<div class="span6 offset3 about-container">
				...
				<p>Technically, absence in our records is <em>not</em> equivalent to absence for the entire day of the corresponding <strong>roll call</strong> record. What it means is that during the time of the <strong>roll call</strong>, the person in question was not present. In general, quorum is dependent on the roll.</p>
				...
				<p><a href="<?=site_url('api/dump')?>">Take a look at our raw data</a></p>
		</div>
	</div>
</section>